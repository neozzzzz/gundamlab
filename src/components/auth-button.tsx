  ...
  if (user) {
    return (
      <div className="flex items-center gap-3">
        {/* Dashboard 버튼 (관리자만) */}
        {isAdmin && (
          <Link href="/admin" className="hidden sm:inline-flex px-3 py-1 text-xs font-mono font-bold tracking-widest uppercase bg-blue-800 hover:bg-blue-700 text-white rounded-full transition-colors">
            Dashboard
          </Link>
        )}
        {/* 사용자 프로필 */}
